...
Si configuré au lancement de la session RStudio, le *pull* de https://github.com/InseeFrLab/funathon2023_sujet2 a dû être fait.
...
# D'autres packages sont nécessaires mais seront appelés directement avec leur
...
mod_simple %>% 
  ...
  as_gt() %>%
  gt::tab_source_note(source_note = glue("Maïs grain France {min(recolte$annee)}-{max(recolte$annee)} 
