...
Ainsi, même si on voit que la variété utilisée a probablement un impact important et que des changements de techniques culturales ont eu lieu, une précocité de semis d'un mois combiné à 10 jours de cultures de plus représente, pour cet exemple, une date de récolte de `r round((-30 + 10) / (2003 - 1977), 1)` jour par an, ce qui n'est pas très éloigné de notre estimation globale.
