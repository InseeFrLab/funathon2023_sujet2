...
labels <- sprintf("<strong>id_parcel : </strong>%s<br/>
                  ...
                  parc_prox$id_parcel,
                  carte_parc_prox_lib$libelle_groupe_culture,
                  carte_parc_prox_lib$libelle_culture,
                  parc_prox$surf_parc,
                  parc_prox$insee_dep,
                  parc_prox$nom_com) %>% 
...
Sélectionnez les statistiques du département concerné et appariez statistiques locales, départementales et nationales par groupe de culture dans un même `data.frame` à afficher.
...
La fonction `facet_wrap` permet de ...
